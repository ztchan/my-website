...
<button onclick=" window.open('https://doi.org/10.1007/s11558-021-09436-y','_blank')"> Google</button> 
<button onclick="toggler('absBehindTheScreen')">Abstract</button> <button onclick="toggler('absBehindTheScreen')">Abstract</button>
